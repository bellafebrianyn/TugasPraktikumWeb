          ...
          <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
              ...
              <div id="content">
                ...
                <div class="ms-4 me-4">
                  <form action="../proses/admin-editproses.php?id_menu=<?= $data['id_menu'] ?>" method="POST">
                    <div class="mb-3 text2">
                      <label for="exampleInputEmail1" class="form-label text4">Menu</label>
                      <input value="<?= $data['menu'] ?> " type="text" name="menu" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan menu">
                    </div>
                    <div class="mb-3 text2">
                      <label for="exampleInputPassword1" class="form-label text4">Deskripsi</label>
                      <input value="<?= $data['deskripsi'] ?>" type="text" class="form-control" name="deskripsi" id="exampleInputPassword1" placeholder="Tulis Deskripsi">
                    </div>
                    <div class="mb-3 text2">
                      <label for="exampleInputPassword2" class="form-label text4">Harga</label>
                      <input value="<?= $data['harga'] ?>" type="number" name="harga" class="form-control" id="exampleInputPassword2" placeholder="Masukkan harga">
                    </div>
                    <br>
                    <br>
                    <center>
                      <div class="">
                        <button type="submit" class="btn btn-outline-primary" style="font-weight: bold;">Edit</button>
                      </div>
                    </center>
                  </form>
                </div>
