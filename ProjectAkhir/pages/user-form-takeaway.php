            ...
            <div class="card" style="width: 70rem;">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <form method="POST" action="../proses/user-takeaway-proses.php">
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td>
                                    ...
                                    <td>
                                        <input class="form-control form-control-sm" type="time" aria-label=".form-control-sm example" name="jam">
                                    </td>
                                    <td>
