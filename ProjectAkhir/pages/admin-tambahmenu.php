                ...
                <div class="container-fluid">
                    ...
                    <div id="wrapper">
                        ...
                        <div id="content-wrapper" class="d-flex flex-column">
                            ...
                            <!-- Main Content -->
                            <div id="content">
                                <form action="../proses/admin-addmenu.php" method="POST">
                                    <div class="mb-3 text2">
                                        <label for="exampleInputEmail1" class="form-label text4">Menu</label>
                                        <input type="text" name="menu" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan menu">
                                    </div>
                                    <div class="mb-3 text2">
                                        <label for="exampleInputPassword1" class="form-label text4">Deskripsi</label>
                                        <input type="text" class="form-control" name="deskripsi" id="exampleInputPassword1" placeholder="Tulis Deskripsi">
                                    </div>
                                    <div class="mb-3 text2">
                                        <label for="exampleInputPassword2" class="form-label text4">Harga</label>
                                        <input type="number" name="harga" class="form-control" id="exampleInputPassword2" placeholder="Masukkan harga">
                                    </div>
                                    <br>
                                    <center>
                                        <div class="d-grid">
                                            <button type="submit" class="w-100 btn btn-outline-primary text4" style="font-weight: bold;">Submit</button>
                                        </div>
                                    </center>
